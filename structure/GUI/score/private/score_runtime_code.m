    ...
    methods (Access = private)
        ...
        function CreateFromPredictionButtonPushed(app, event) %#ok<INUSD>
            ...
            try
                ...
                classif = app.AnnotationSession.Classifier;
                roiIndex = app.AnnotationSession.RoiIndex;
                predictionPlan = [];
                activeModel = annotationActiveModelInfo(classif, roiIndex);
                if activeModel.supported
                    try
                        ...
                        activeModel = annotationActiveModelInfo( ...
                            classif, roiIndex, predictionPlan);
                    catch ME
            ...
            if strcmp(recipe.mode, 'run_prediction')
                ...
                if overwrite || hasExistingPrediction
                    replacement = ['recompute and replace the current model ' ...
                        'prediction'];
                    if overwrite
                        replacement = [replacement ' and replace the current ' ...
                    ...
                    choice = uiconfirm(app.ScoreAppUIFigure, [ ...
                        ...
                        '? No segmentation will be run. The refined output ' ...
        ...
        function ReviewFindingsButtonPushed(app, event) %#ok<INUSD>
            ...
            try
                progress = uiprogressdlg(app.ScoreAppUIFigure, ...
                    ...
                    'Message', 'Auditing GT and preparing the findings table...', ...
                    'Indeterminate', 'on');
                drawnow limitrate;
