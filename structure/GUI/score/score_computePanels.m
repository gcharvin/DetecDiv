function roiOverlay=score_computePanels(obj, param)
...
for cc = 1:numROI
    ...
    numFrames = numel(param.frames);
    compositeFrames = zeros(param.imagesize, 'uint8');
    overlayFrames= zeros(param.imagesize, 'uint8');
    alphaFrames= zeros(param.imagesize(1),param.imagesize(2), 'uint8'); % HERE
