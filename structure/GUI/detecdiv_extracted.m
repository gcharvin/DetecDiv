    ...
    if strcmp(str,'Projectprocess')
        ...
        processDataGUI(shallowObj, proc);
            ...
            function executeProjectPipelineRun(projIdx, runIdx)
                ...
                runObj = shallowObj.processing.pipelineRun(runIdx);
                [pipeObj, msg] = resolvePipelineFromRun(runObj);
                if isempty(pipeObj)
            ...
            function [pipeObj, msg] = resolvePipelineFromRun(runObj)
                pipeObj = [];
    ...
    methods (Access = private)
        ...
        function TreeSelectionChanged(app, event)
            ...
            if strcmp(selectedNodes.Tag,'Project')
                ...
                app.IdentifyROIsinpositionsButton.Visible='on';
                app.ExtractROIhypervolumesButton.Visible='on';
