...
assert(isscalar(legacy.resources.out) && ...
    strcmp(legacy.resources.out.type, 'dataSeries') && ...
    strcmp(legacy.resources.out.role, 'lineage') && ...
    strcmp(legacy.resources.out.nameParam, 'outputFamilyName'), ...
    'cellLatentModel must expose outputFamilyName as dataSeries lineage.');
