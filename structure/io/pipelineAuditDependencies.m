        ...
        case 'classifier'
            ...
            if strcmp(pkg, 'cellposesam')
                ...
                contract.inference.include = { ...
                    ...
                    'glob:**/*.yaml', ...
                    'glob:**/*.yml'};
            elseif strcmp(pkg, 'sam31')
                % SAM3.1 classifiers keep very large training/checkpoint
                % artifacts under modulePath/sam31_artifacts. A generic
                % recursive audit for **/*.pt would walk multi-GB checkpoints
                % every time pipeline2 saves a classifier template. Keep this
                % audit intentionally shallow; the runner resolves SAM3.1
                % checkpoints and repo paths from package defaults/config.
                contract.inference.include = { ...
                    'file:%ID%_classification.mat', ...
                    'file:trainingParam.json', ...
                    'file:runProfiles.json'};
                contract.training.include = { ...
                    'file:trainingdataset/%ID%_sam31_framebank.h5', ...
                    'file:trainingdataset/train/_annotations.coco.json', ...
                    'file:trainingdataset/train/_annotations.moma_video.json', ...
                    'file:trainingdataset/val/_annotations.coco.json', ...
                    'file:trainingdataset/val/_annotations.moma_video.json'};
