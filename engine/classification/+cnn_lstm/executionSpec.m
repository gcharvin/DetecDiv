...
spec.defaults = struct( ...
    ...
    'outputName', 'div_1', ...
    'cnnOutputName', 'cnn_div_1', ...
    'executionEnvironment', 'module_default');

spec.labels = struct( ...
    'outputMode', 'Output resource', ...
    'outputName', 'LSTM output name', ...
    'cnnOutputName', 'CNN output name', ...
    'executionEnvironment', 'Execution environment');

spec.tips = struct( ...
    'outputMode', ['Controls which inference outputs this pipeline node writes: ' ...
                   'LSTM dataseries, CNN dataseries, or both.'], ...
    'outputName', 'Dataseries group name used for the primary LSTM output.', ...
    'cnnOutputName', 'Dataseries group name used when a separate CNN output is written.', ...
