...
if nargin==2 % basic parameter initialization
        ...
        tip={'Choose the training method',...
            ...
            'Enter the fold change in training data number',...
            'Enter whether custom translation is permitted for data augmentation',...
            'Choose execution environment',...
             'Set result output threshold [0 - 1] for objects',...
             'Set result mask threshold [0 - 1] for segmentation',...
            'Select initial version of network to start training with; Default: ImageNet'};
      
        classif.trainingParam=struct('CNN_training_method',{{'adam','sgdm','sgdm'}},...
            ...
            'CNN_augmentation_scale',10,...
            'CNN_translation_augmentation',true,...
...
[classifier, info]= trainSOLOV2(trainDS,lgraph,options,FreezeSubNetwork="none");
