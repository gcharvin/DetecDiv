...
spec.tips = struct( ...
    ...
    'buddingProposal', ['Keep the pretrained Trackastra model for ordinary links and use the packaged budding-finetuned model only to add/re-score bud candidates. ' ...
        'Requires the joint decoder. If modelSource is custom, that custom Trackastra artifact is used as the proposal model.'], ...
