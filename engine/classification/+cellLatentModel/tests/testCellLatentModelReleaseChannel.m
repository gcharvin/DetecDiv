...
verifyEqual(testCase,resolved.annotationParentRerankerManifestPath, ...
    expected.annotationParentRerankerManifestPath);
verifyEqual(testCase,resolved.annotationBudneckModelManifestPath, ...
    expected.annotationBudneckModelManifestPath);
...
annotationRerankerPath=fullfile(releaseDir,'annotation_parent_reranker.json');
writeText(annotationRerankerPath,'{"format":"annotation-parent-reranker"}');
annotationBudneckPath=fullfile(releaseDir,'annotation_budneck_model.json');
writeText(annotationBudneckPath,'{"format":"annotation-budneck-parent"}');
...
artifacts=[artifact('modelPath','parent.pt','file',sha256(modelPath)); ...
    ...
    artifact('annotationParentRerankerManifestPath', ...
        'annotation_parent_reranker.json','file', ...
        sha256(annotationRerankerPath)); ...
    artifact('annotationBudneckModelManifestPath', ...
        'annotation_budneck_model.json','file', ...
        sha256(annotationBudneckPath)); ...
...
expected=struct('modelPath',modelPath, ...
    ...
    'annotationParentRerankerManifestPath',annotationRerankerPath, ...
    'annotationBudneckModelManifestPath',annotationBudneckPath, ...
