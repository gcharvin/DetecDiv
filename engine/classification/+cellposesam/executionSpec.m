...
spec.tips = struct( ...
    ...
    'outputName', 'Name used for the segmentation mask resource and ROI results channel.', ...
    'probabilityOutputName', 'Name used for the Cellpose probability ROI image channel.', ...
