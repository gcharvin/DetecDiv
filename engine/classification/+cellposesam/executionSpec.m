...
spec.staticKeys = {'outputType','diameter','min_size','flow_threshold', ...
    'cell_prob_threshold','trackInstances'};
spec.outputKeys = {'outputName','probabilityOutputName'};
spec.defaultImportKeys = {'outputType','diameter','min_size','flow_threshold', ...
    'cell_prob_threshold','trackInstances'};
...
spec.labels.trackInstances = 'Propagate instance IDs between frames';
...
spec.tips.trackInstances = [ ...
    'Legacy standalone CellposeSAM behavior. Disable when a downstream ' ...
    'tracker owns temporal identity and requires frame-local instances.'];
