...
[merged, action] = sam31.mergeTrackCorrectionFrame(labels, candidate, 2, ...
    struct('allowIdentityReassignment', true));
...
function testRejectsIdentityTransferByDefault(testCase)
labels = zeros(12, 12, 'uint16');
labels(2:4, 2:4) = 2;
labels(7:10, 7:10) = 12;
candidate = false(12, 12);
