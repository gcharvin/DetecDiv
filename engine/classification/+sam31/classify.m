...
fprintf('[SAM31 classify] effective params: backend=%s image_size=%g max_num_objects=%g score=%.3g new_det=%.3g det_nms=%.3g assoc_iou=%.3g runner=%s stages=[instance=%d tracking=%d bud_pairing=%d]\n', ...
    cfg.backend, ...
