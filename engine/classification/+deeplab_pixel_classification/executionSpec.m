...
spec.outputProvenance = struct('quality','pred', ...
    'producer','deeplab_pixel_classification', ...
...
spec.defaults = struct( ...
    ...
    'outputName', 'pred_deeplab_semantic_mask', ...
    'probabilityOutputName', 'pred_deeplab_probability', ...
...
spec.labels = struct( ...
    ...
    'outputName', '[PRED] Segmentation output name', ...
    'probabilityOutputName', '[PRED] Probability output name', ...
...
spec.tips = struct( ...
    ...
    'outputName', ['Prediction name used for the semantic mask resource and ROI ' ...
                   'result channel. Historical classifier IDs remain valid.'], ...
    'probabilityOutputName', ['Prediction name used for the grayscale DeepLab ' ...
                              'probability channel; this is never GT.'], ...
