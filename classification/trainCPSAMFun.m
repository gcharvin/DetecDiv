...
if nargin == 2
    tip = {
        ...
        'Minimum size to keep (object)',
         ' Flow threshold',
         'Cell probability threshold -6 --> 6; default : 0',
...
if isfield(trainingParam, 'verbose') && trainingParam.verbose
...
train_dir_clean, ...
save_path_clean, ...
logger_line, ...          % <--- NE PAS OUBLIER CE PARAMÈTRE !
pretrained_arg, ...
