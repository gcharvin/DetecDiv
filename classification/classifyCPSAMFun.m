...
% ==== Script Python (écriture directe .mat) ====
py_script = sprintf( ...
    "import os\n" + ...
    "import numpy as np\n" + ...
    ...
    "    print(f'[Frame {frame_idx}] Nombre de labels :', np.max(masks))\n" + ...
    ...
    tmp_mat_path_clean, gpu_flag, model_path_clean, model_path_clean, ...
    formatFloat(diameter), num2str(flow_threshold), classif_path_clean);
