...
obj.processing.classification(classiid).roi(classitype).display.selectedchannel(channel)=1;
 ...
 pix = obj.processing.classification(classiid).roi(classitype).findChannelID(obj.processing.classification(classiid).strid);
...
%        
%         if numel(cc)
            obj.processing.classification(classiid).roi(classitype).display.selectedchannel(pix)=1;
   %     end
